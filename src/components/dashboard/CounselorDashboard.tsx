    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
        ...
        <section className="rounded-3xl border border-[var(--border)] bg-white shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="divide-y divide-[var(--border)] p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-[var(--muted-foreground)]">
                  Student Members
          ...
          <div className="p-4 bg-[var(--surface)]/30 border-t border-[var(--border)] mt-auto space-y-2">
            <Link
              href="/dashboard/members"
              className="flex items-center justify-between rounded-xl bg-white border border-[var(--border)] px-4 py-3 text-xs font-bold text-[var(--secondary)] shadow-sm transition-all hover:bg-slate-50"
            >
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
        <section className="rounded-3xl border border-[var(--border)] bg-white shadow-sm overflow-hidden">
          <div className="border-b border-[var(--border)] bg-[var(--surface)]/30 px-6 py-5">
            <h2 className="text-lg font-bold text-[var(--secondary)]">
              Branch Management
            </h2>
        ...
        <section className="rounded-3xl border border-[var(--border)] bg-white shadow-sm overflow-hidden lg:col-span-2">
          <div className="flex items-center justify-between border-b border-[var(--border)] bg-[var(--surface)]/30 px-6 py-5">
            <div>
              <h2 className="text-lg font-bold text-[var(--secondary)]">
